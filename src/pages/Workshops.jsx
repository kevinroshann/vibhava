...
const eventList = [
  {
    ...
    isComingSoon: false,
    src: "mountain.jpg", // Image source for the event
    link: "/Workshop",
  },
  {
    title: "Event2",
  ...
  // {
  //   title: "Much more",
  //   description: "Details about more events.",
  //   isComingSoon: true,
  //   src: "mountain.jpg", // Image source for the event
  //   link: "/MoreEvents",
  // },
  ...
  <section className="bg-black pb-52">
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        <p className="font-circular-web text-6xl text-blue-50">Workshops</p>
