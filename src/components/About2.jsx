const AboutSection = () => {
    return (
      <div className="sm:p-6 md:p-10 my-5 md:my-10 lg:my-16" id="about">
        <div className="box-border flex flex-col md:flex-row border border-black rounded-[6px] md:rounded-[15px] p-4 sm:p-6 md:p-8 lg:p-12 gap-3 md:gap-5 bg-white">
          ...
          vibhava innovation Summit 2025 is a premier technical conclave desined to showcase the ingenuity,technical prowess and innovative spirit of SOE students CUSAT vibhava innovation Summit 2025 is a premier technical conclave desined to showcase the ingenuity,technical prowess and innovative spirit of SOE students CUSAT vibhava innovation Summit 2025 is a premier technical conclave desined to showcase the ingenuity,technical prowess and innovative spirit of SOE students CUSAT 
          </p>
